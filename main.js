...
const createButtonClickCounter = (buttonName) => {
    let totalClicks = 0;
    return () => {
        totalClicks++;
...
const handleAttack = (damage, buttonType) => {
...
const generateLog = (character, enemy) => {
...
const logFight = (character, enemy, damageCharacter, damageEnemy, isGameOver = false) => {
